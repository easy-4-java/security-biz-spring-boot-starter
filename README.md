...
| JDK | `17` |
| Coordinates | `io.github.easy4j:security-biz-spring-boot-starter:1.0.0-SNAPSHOT` |
...
| `ObjectMapper` bean | ✅ Stable | Auto-registered via SecurityBizAutoConfiguration, SecurityFormFilterAutoConfiguration |
